...
@push('scripts')
    <script>
        ...
        //             // Set input text dengan label yg dipilih
        //             $(this).val(ui.item.label);
        //             // Set kolom Number + hidden input
        //             const td = $(this).closest('tr').find('td.spare-number');
        //             td.find('.spare-number-text').text(ui.item.number);
        //             td.find('input[name="product_number[]"]').val(ui.item.number);
        //             return false;
        //         }
        //     }).autocomplete("instance")._renderItem = function(ul, item) {
        //         return $("<li>").append("<div>" + item.label + "</div>").appendTo(ul);
