                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="nomer_asset" name="nomer_asset" class="form-control"
                                            value="{{ $riwayatperbaikanassetit->nomer_asset }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="nama" name="nama" class="form-control"
                                            value="{{ $riwayatperbaikanassetit->nama }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="user" name="user" class="form-control"
                                            value="{{ $riwayatperbaikanassetit->user }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('kerusakan') is-invalid @enderror"
                                            ...
                                            value="{{ $riwayatperbaikanassetit->kerusakan }}" readonly>
                                        @error('kerusakan')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                {{-- <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('perbaikan') is-invalid @enderror"
                                            ...
                                            value="{{ $riwayatperbaikanassetit->perbaikan }}" readonly>
                                        @error('perbaikan')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan"
                                            rows="4" readonly>{{ $riwayatperbaikanassetit->keterangan }}</textarea>
