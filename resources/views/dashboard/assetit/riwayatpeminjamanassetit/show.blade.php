        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-10">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Detail Peminjaman Asset IT</h5>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="nomer_asset" name="nomer_asset" class="form-control"
                                            value="{{ $riwayatpeminjamanassetit->nomer_asset }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="nama" name="nama" class="form-control"
                                            value="{{ $riwayatpeminjamanassetit->nama }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="user" name="user" class="form-control"
                                            value="{{ $riwayatpeminjamanassetit->user }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input id="tanggalMulai" type="text" class="form-control" autocomplete="off"
                                            value="{{ \Carbon\Carbon::parse($riwayatpeminjamanassetit->tanggal_pinjam)->translatedFormat('d F Y') }}" disabled>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan"
                                            rows="4" readonly>{{ $riwayatpeminjamanassetit->keterangan }}</textarea>
