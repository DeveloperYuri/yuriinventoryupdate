        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-10">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Detail Asset IT</h5>
                            ...
                            <form id="myForm" action="{{ route('asset-it.update', $assetit->id) }}" method="POST"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"
                                            ...
                                            name="nomer_asset" value="{{ $assetit->nomer_asset }}" readonly>
                                        @error('nomer_asset')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                            id="inputText" name="nama" value="{{ $assetit->nama }}" readonly>
                                        @error('nama')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('user') is-invalid @enderror"
                                            id="inputText" name="user" value="{{ $assetit->user }}" readonly>
                                        @error('user')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="locations_id" class="form-control ..." disabled>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control @error('spesifikasi') is-invalid @enderror" id="spesifikasi" name="spesifikasi"
                                            rows="14" readonly>{{ $assetit->spesifikasi }}</textarea>
