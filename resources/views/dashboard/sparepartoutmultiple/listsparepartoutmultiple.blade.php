...
@section('content')
    <main id="main" class="main">
        ...
        @if (Auth::user()->is_role == 2 || Auth::user()->is_role == 1)
            <div class="pagetitle">
                <a href="{{ route('sparepartoutmultiple.createout') }}" class="btn btn-primary" dusk="createsparepartin">Create
                    New Spare Part Out</a>
            </div><!-- End Page Title -->
        @endif
                                        ...
                                        @forelse ($transactions as $index => $out)
                                            ...
                                            <div class="modal fade" id="batalModal{{ $out->id }}" tabindex="-1">
                                                <div class="modal-dialog">
                                                    <form action="{{ route('spartpartkeluar.batal', $out->id) }}"
                                                        method="POST">
                                                        @csrf
