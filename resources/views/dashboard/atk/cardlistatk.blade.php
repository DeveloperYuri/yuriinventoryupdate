    ...
    <main id="main" class="main">
            ...
            <div class="pagetitle d-flex justify-content-between align-items-center">
                @if (Auth::user()->is_role == 2 || Auth::user()->is_role == 1)
                 <a href="{{ route('atk.create') }}" class="btn btn-primary">Add ATK</a>
                @endif

                <a href="{{ route('atk.index') }}" class="btn btn-secondary"><i class="bi bi-list"></i></a>
            </div>
        ...
        <section class="section">
            ...
            <div class="row">
                ...
                @foreach ($getRecordCard as $index => $atk)
                    <div class="col-lg-4 mt-3">
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <h5 class="card-title text-center">{{ $atk->name }}</h5>
                                <p class="card-text mb-1">Price : Rp {{ number_format($atk->price, 0, ',', '.') }}</p>
                                <p class="card-text">Stock : {{ $atk->stock }}</p>
                                @if (Auth::user()->is_role == 2)

                                <div class="d-flex gap-2 mt-2">
                                    <a href="{{ route('atk.detail', ['id' => $atk->id]) }}" class="btn btn-info btn-sm">
                                        History Detail
                                    </a>
