...
@section('content')
    ...
    ">
                                            ...
                                            <td class="text-center column-keterangan">{{ $item->keterangan ?? '-' }}</td>
                                        ...
                                        <div class="modal fade" id="batalModal{{ $item->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('atk.history.batal', $item->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        ...
                                                        <div class="modal-body">
                                                            <p>
                                                                Yakin ingin membatalkan transaksi ATK
                                                                <strong>{{ $item->atk->name ?? '-' }}</strong>
