                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" class="mt-4" action="{{ route('suratpesanan-atk.store') }}" method="POST">
                                @csrf
                                <div class="row mb-3">
                                    <!-- Kiri -->
                                    <div class="col-md-6">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text"
                                                    ...
                                                    name="dibuat_oleh" value="{{ old('dibuat_oleh') }}">
                                                @error('dibuat_oleh')
                                                ...
                                                @if (old('product'))
                                                    @foreach (old('product') as $i => $productId)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button type="button"
                                                                    class="btn btn-danger btn-sm removeLine">Hapus</button>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                @endif
