                        ...
                        <div class="card-body">
                            ...
                            <form class="mt-4" action="{{ route('sparepartinmultiple.store') }}" method="POST">
                                ...
                                <div class="mt-3">
                                    ...
                                    <textarea class="form-control" name="keterangan" id="keterangan" rows="3" placeholder="Masukkan keterangan" readonly>{{ $atktransaction->keterangan }}</textarea>
                                </div>
                            </form>
