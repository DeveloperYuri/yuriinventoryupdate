                ...
                <div class="col-lg-10">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Horizontal Form -->
                            <form action="{{ route('asset-tools.update', $assetTools->id) }}" method="POST"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        @if ($assetTools->image)
                                            <img src="{{ asset('images/' . $assetTools->image) }}"
                                                alt="{{ $assetTools->name }}" width="100">
                                        @else
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputText" name="name"
                                            value="{{ $assetTools->name }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputText" name="price"
                                            value="{{ $assetTools->price }}" required>
                                    </div>
                                </div>
                                        ...
                                        <select name="satuan_id" class="form-control" required>
                                            ...
                                            @foreach ($satuans as $satuan)
                                                <option value="{{ $satuan->id }}"
                                                    {{ $assetTools->satuan_id == $satuan->id ? 'selected' : '' }}>
                                                    {{ $satuan->name }}
                                                </option>
                                            @endforeach
                                        </select>
