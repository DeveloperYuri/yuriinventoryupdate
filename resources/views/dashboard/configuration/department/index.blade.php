...
@section('content')
    <main id="main" class="main">
        ...
        @if (Auth::user()->is_role == 2 || Auth::user()->is_role == 1)
            <div class="pagetitle">
                <a href="{{ route('create.department') }}" class="btn btn-primary">Tambah Department</a>
            </div><!-- End Page Title -->
        @endif
                ...
                <div class="row g-2 align-items-center">
                    <div class="col">
                        <input id="searchingtitle" type="text" class="form-control" value="{{ Request()->name }}"
                            placeholder="Searching Department" name="name">
                    </div>
                    <div class="col-auto">
        ...
        <section class="section">
            <div class="row mt-4">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Daftar Department</h5>
                                            ...
                                            <tr>
                                                ...
                                                @if (Auth::user()->is_role == 2)
                                                    <td class="text-center">
                                                        <form action="{{ route('delete.department', $data->id) }}" method="POST">
