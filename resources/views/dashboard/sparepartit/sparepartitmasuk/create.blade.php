                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h2 class="mt-4">Form Penerimaan Spare Part IT</h2>

                            <form id="myForm" class="mt-4" action="{{ route('sparepartitinmultiple.store') }}" method="POST">
                                @csrf
                                <div class="row mb-3">
                                    <!-- Kiri -->
                                    <div class="col-md-6">
                                    ...
                                    <div class="tab-pane fade show active" id="operations" role="tabpanel">
                                        <table class="table" id="productTable">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td colspan="3">
                                                        <a href="#" id="addLineBtn">Tambah Spare Part IT</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div class="mt-3">
                                    ...
                                    <a href="{{ route('sparepartitinmultiple.index') }}" class="btn btn-secondary">Kembali</a>
                                </div>
    ...
    <script>
        ...
        $(function() {
            ...
            addLineBtn.on('click', function(event) {
                ...
                <tr>
                    <td>
                        <input type="text" name="product_name[]" class="form-control" placeholder="Masukkan Nama ATK">
                    ...
                    <td>
                        <button type="button" class="btn btn-danger btn-sm removeLine">Hapus</button>
                    </td>
                </tr>
            `);
