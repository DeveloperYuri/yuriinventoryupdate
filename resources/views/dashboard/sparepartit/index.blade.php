    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle d-flex justify-content-between align-items-center">
            @if (Auth::user()->is_role == 2 || Auth::user()->is_role == 4)
                <a href="{{ route('sparepart-it.create') }}" class="btn btn-primary">Tambah Spare Part IT</a>
            @endif
        </div>
                ...
                <div class="row g-2 align-items-center">
                    <div class="col-4">
                        <input type="text" id="searchingtitle" name="name" class="form-control" value="{{ request('name') }}"
                            placeholder="Nama Spare Part IT">
                    ...
                    <div class="col-auto">
                        ...
                        <a href="{{ route('sparepart-it.index') }}" class="btn btn-secondary">Reset</a>
                    </div>
                </div>
            </form>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h5 class="card-title mb-0">Daftar Spare Part IT</h5>
                                ...
                                @if (Auth::user()->is_role == 2 || Auth::user()->is_role == 1)
                                    <div class="d-flex gap-2">
                                        ...
                                        <a href="{{ route('sparepart-it.cetakpdf') }}" class="btn btn-success"
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @if (Auth::user()->is_role == 4 || Auth::user()->is_role == 2)
                                                        ...
                                                        <form action="{{ route('sparepart-it.delete', $part->id) }}"
    ...
    <script>
        $(function() {
            $("#searchingtitle").autocomplete({
                source: "{{ route('sparepart-it.autocomplete') }}",
                minLength: 1, // mulai search setelah 2 karakter
            });
        });
    </script>
