                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h2 class="mt-4">Form Permintaan Spare Part</h2>

                            <form id="myForm" class="mt-4" action="{{ route('suratpermintaansparepart.store') }}" method="POST">
                                @csrf
                                <div class="row mb-3">
                                    <!-- Kiri -->
                                    <div class="col-md-6">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="no_surat_permintaan"
                                ...
                                <div class="mt-3">
                                    ...
                                    <a href="{{ route('suratpermintaansparepart.index') }}" class="btn btn-secondary">Kembali</a>
                                </div>
                            </form>
                        </div>
                    </div>
