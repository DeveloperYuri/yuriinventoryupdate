                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-4 align-items-center">
                                <div class="col-md-8">
                                    <h2 class="mt-2">Form Edit Permintaan Barang</h2>
                                </div>
                            </div>

                            <form class="mt-4" action="{{ route('suratpermintaansparepart.update', $transaction->id) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control"
                                                    value="{{ $transaction->no_surat_permintaan }}" readonly>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label class="col-sm-4 col-form-label">Di buat oleh</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" value="{{ $transaction->name }}"
                                                    name="name">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <select id="subcategory_id" name="subcategory_id"
                                                    ...
                                                    @if ($transaction->subcategory)
                                                        <option value="{{ $transaction->subcategory->id }}" selected>
                                ...
                                <a href="{{ route('suratpermintaansparepart.index') }}" class="btn btn-success mt-2">Kembali</a>
                            </form>
