    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle d-flex justify-content-between align-items-center">
            @if (Auth::user()->is_role == 2 || Auth::user()->is_role == 0)
                <a href="{{ route('suratpesananbaru.create') }}" class="btn btn-primary" dusk="addsparepart">Buat Surat
                    Pesanan</a>
            @endif
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h5 class="card-title mb-0">Daftar Surat Pesanan Baru</h5>
                                ...
                                <table class="table table-hover align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($getRecord as $index => $sp)
                                            <tr onclick="window.location='{{ route('suratpesananbaru.show', $sp->id) }}'"
                                                ...
                                                <td class="text-center"> {{ $sp->department->name ?? '-' }}
                                                </td>
